        ...
        fields: [
          {
            ...
            hint: "Selecione a unidade de negócio usada pela tabela oficial.",
          },
        ],
      },
      {
        ...
        fields: [
          {
            ...
            required: true,
            options: ["MCMV", "SPBE"],
            hint: "Para compra que não seja o primeiro imóvel, a modalidade efetiva será SPBE.",
          },
          {
            key: "first-property",
        ...
        fields: [
          {
            ...
            type: "currency",
            required: true,
            hint: "Base oficial para ITBI e registro da compra e venda.",
          },
          {
            key: "bank-appraisal",
            ...
            type: "currency",
            required: true,
            hint: "Base para o teto de financiamento da modalidade.",
          },
          {
            key: "financing",
            label: "Financiamento",
            type: "currency",
            required: true,
            hint: "O valor não pode superar a venda nem o teto sobre a avaliação.",
          },
          {
            key: "family-income",
            ...
            type: "currency",
            required: true,
            hint: "Obrigatória para validar o enquadramento MCMV.",
          },
          {
            key: "base-date",
            label: "Data-base",
            type: "date",
            required: true,
            hint: "Início da janela oficial de 120 dias para o primeiro vencimento.",
          },
          {
            key: "requested-first-installment",
            label: "Primeiro vencimento solicitado",
            type: "date",
            hint: "Opcional. Deve cair nos dias 5, 10 ou 15 dentro da janela oficial.",
          },
        ],
      },
      {
