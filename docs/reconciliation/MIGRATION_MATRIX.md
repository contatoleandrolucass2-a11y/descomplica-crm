...
|    25 | `20260810165927_qlik_relay_mapping_cutover`                    |  Sim  |  Não   | `34f2c59b07cea31d34a72f27fae4d14ee5f308743af78411289bd61666565374` | —                                                                  | Papel/RPC relay mínimos, gate, ledger sanitizado, autoridades e importação de mappings.                       | Somente local; inerte e sem credenciais reais               | Manter flags off; exige owners, restore, provisioning privado, shadow/canário e autorizações separadas.          |
...
históricos do banco remoto. As versões 21–25 são somente locais; nenhuma delas
...
3. validar que a ponte aditiva preserva a RPC legada em restore representativo;
...
7. validar relay shadow por duas janelas e canário controlado antes de agendar a revogação;
