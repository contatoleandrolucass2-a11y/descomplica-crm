...
“não identificada”. As versões 14, 15, 19, 21–27 e 29 continuam somente locais;
nenhuma foi aplicada ao projeto remoto. As versões 28 e 30 foram aplicadas
isoladamente como contenção e roll-forward P0; as versões remotas inseguras `20260813142723` e
