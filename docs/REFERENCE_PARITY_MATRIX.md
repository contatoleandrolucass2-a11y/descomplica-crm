...
| REF-14 | Associativo fluxo linear: formulário e resultado WF13              | Formulário, resultado e memória oficial        | Paridade PDF 2 + ranking e anuais 15/12                         | Fórmula `wf13-1.2.0`; execução Master-only por gate independente   | Validação funcional humana do caso de ouro e matriz Looker                   | Canário WF13 isolado |
