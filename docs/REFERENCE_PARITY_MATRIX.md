...
| REF-14 | Associativo fluxo linear: formulário e resultado WF13              | Motor oficial versionado e desligado por flag  | Seções, campos, alertas e painel completos                      | Doze casos de ouro; execução somente em canário Master             | Validar canário humano antes de qualquer liberação geral                     | Canário pendente |
| REF-15 | Documentação: formulário e resultado WF16                          | Motor oficial versionado e desligado por flag  | Seções, opções e painel completos                               | Treze casos de ouro; execução somente em canário Master            | Validar canário humano antes de qualquer liberação geral                     | Canário pendente |
