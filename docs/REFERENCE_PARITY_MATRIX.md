...
- `réplica operacional`: artefato fornecido reproduzido integralmente, isolado do
  runtime oficial e sem persistência.
...
Um motor oficial bloqueado ou uma integração pendente só pode avançar quando houver
