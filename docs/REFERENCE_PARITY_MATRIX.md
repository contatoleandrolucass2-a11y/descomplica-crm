...
| REF-14 | Associativo fluxo linear: formulário e resultado WF13              | Formulário, resultado e memória oficial        | Paridade PDF 2: saldo nominal, datas, mensal e centavos         | Fórmula `wf13-1.1.0`; execução Master-only por gate independente   | Validação funcional humana do caso de ouro antes do próximo motor            | Canário WF13 isolado |
